// Simplified Android (Material 3) device frame — status bar + top app bar +
// content + gesture nav. Ported from the "Mobile credit score animation"
// asset's android-frame.jsx starter component into a normal ES module.

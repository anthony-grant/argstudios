...
//
// An image with a non-empty `description` becomes clickable: its label renders
// as a small button on the thumbnail and links to its own page at
// /work/additional-projects/<slug>, where the description (with any inline
// [text](url) links) and an optional external link button are shown.
...
// Homepage hero, nav, and profile image — all editable from /admin under
...
export const homeHero = {
  ...
  // Supports one or more inline [text](url) links.
